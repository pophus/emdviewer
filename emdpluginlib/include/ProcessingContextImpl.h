...
#ifndef EMD_PROCESSINGCONTEXTIMPL_H
#define EMD_PROCESSINGCONTEXTIMPL_H
...
{
public:
    ProcessingContextImpl(const FrameSet::Selection &selection);
...
private:
    std::unique_ptr<FrameSet> m_frameSet;
};
